...
(event_id, event_created_at, event_type, invoice_id, payment_id, adjustment_id, party_id, party_shop_id, adjustment_status, adjustment_status_created_at, adjustment_created_at, adjustment_reason, adjustment_fee, adjustment_provider_fee, adjustment_external_fee)
  SELECT
    event_id,
    event_created_at,
    event_type,
