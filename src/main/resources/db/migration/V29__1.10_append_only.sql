...
CREATE TABLE mst.invoice_details (
  invoice_id             CHARACTER VARYING           NOT NULL,
...
CREATE TABLE payment_cash_flow (
  invoice_id           CHARACTER VARYING NOT NULL,
  payment_id           CHARACTER VARYING NOT NULL,
  ...
  CONSTRAINT payment_cash_flow_pkey PRIMARY KEY (invoice_id, payment_id)
);
...
CREATE TABLE payment_details (
  ...
  CONSTRAINT payment_details_pkey PRIMARY KEY (invoice_id, payment_id)
);
...
CREATE TABLE refund_details (
  ...
  CONSTRAINT refund_details_pkey PRIMARY KEY (invoice_id, payment_id, refund_id)
);
...
CREATE TABLE adjustment_details (
  ...
  CONSTRAINT adjustment_details_pkey PRIMARY KEY (invoice_id, payment_id, adjustment_id)
);
...
CREATE TABLE payout_details (
  ...
  CONSTRAINT payout_event_pkey PRIMARY KEY (payout_id)
);
