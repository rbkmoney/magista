...
public class PaymentData extends TableImpl<PaymentDataRecord> {
    ...
    private static final long serialVersionUID = -744494817;
     ...
     */
    public final TableField<PaymentDataRecord, PaymentTool> PAYMENT_TOOL = createField("payment_tool", org.jooq.impl.SQLDataType.VARCHAR.nullable(false).asEnumDataType(com.rbkmoney.magista.domain.enums.PaymentTool.class), this, "");
     ...
     */
    public final TableField<PaymentDataRecord, BankCardTokenProvider> PAYMENT_BANK_CARD_TOKEN_PROVIDER = createField("payment_bank_card_token_provider", org.jooq.impl.SQLDataType.VARCHAR.asEnumDataType(com.rbkmoney.magista.domain.enums.BankCardTokenProvider.class), this, "");
     ...
     */
    public final TableField<PaymentDataRecord, PaymentFlow> PAYMENT_FLOW = createField("payment_flow", org.jooq.impl.SQLDataType.VARCHAR.nullable(false).asEnumDataType(com.rbkmoney.magista.domain.enums.PaymentFlow.class), this, "");

    /**
     * The column <code>mst.payment_data.payment_hold_on_expiration</code>.
     */
    public final TableField<PaymentDataRecord, OnHoldExpiration> PAYMENT_HOLD_ON_EXPIRATION = createField("payment_hold_on_expiration", org.jooq.impl.SQLDataType.VARCHAR.asEnumDataType(com.rbkmoney.magista.domain.enums.OnHoldExpiration.class), this, "");
     ...
     */
    public final TableField<PaymentDataRecord, PaymentPayerType> PAYMENT_PAYER_TYPE = createField("payment_payer_type", org.jooq.impl.SQLDataType.VARCHAR.nullable(false).asEnumDataType(com.rbkmoney.magista.domain.enums.PaymentPayerType.class), this, "");

    /**
     * The column <code>mst.payment_data.payment_country_id</code>.
     */
    public final TableField<PaymentDataRecord, Integer> PAYMENT_COUNTRY_ID = createField("payment_country_id", org.jooq.impl.SQLDataType.INTEGER, this, "");

    /**
     * The column <code>mst.payment_data.payment_city_id</code>.
     */
    public final TableField<PaymentDataRecord, Integer> PAYMENT_CITY_ID = createField("payment_city_id", org.jooq.impl.SQLDataType.INTEGER, this, "");

    /**
     * Create a <code>mst.payment_data</code> table reference
     */
    public PaymentData() {
        this(DSL.name("payment_data"), null);
    }
    ...
    public PaymentData(String alias) {
        this(DSL.name(alias), PAYMENT_DATA);
    }

    /**
     * Create an aliased <code>mst.payment_data</code> table reference
     */
    public PaymentData(Name alias) {
        this(alias, PAYMENT_DATA);
    }

    private PaymentData(Name alias, Table<PaymentDataRecord> aliased) {
        this(alias, aliased, null);
    }

    private PaymentData(Name alias, Table<PaymentDataRecord> aliased, Field<?>[] parameters) {
        super(alias, null, aliased, parameters, DSL.comment(""));
    }

    public <O extends Record> PaymentData(Table<O> child, ForeignKey<O, PaymentDataRecord> key) {
        super(child, key, PAYMENT_DATA);
    }
    ...
    public List<Index> getIndexes() {
        return Arrays.<Index>asList(Indexes.PAYMENT_DATA_PAYMENT_CREATED_AT_IDX, Indexes.PAYMENT_DATA_PKEY, Indexes.PAYMENT_DATA_UKEY);
    }
    ...
    public List<UniqueKey<PaymentDataRecord>> getKeys() {
        return Arrays.<UniqueKey<PaymentDataRecord>>asList(Keys.PAYMENT_DATA_PKEY, Keys.PAYMENT_DATA_UKEY);
    }
    ...
    public PaymentData as(String alias) {
        return new PaymentData(DSL.name(alias), this);
    }
     ...
     */
    @Override
    public PaymentData as(Name alias) {
    ...
    public PaymentData rename(String name) {
        return new PaymentData(DSL.name(name), null);
    }
     ...
     */
    @Override
    public PaymentData rename(Name name) {
