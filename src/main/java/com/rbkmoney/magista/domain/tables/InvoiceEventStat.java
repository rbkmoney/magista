...
public class InvoiceEventStat extends TableImpl<InvoiceEventStatRecord> {
    ...
    private static final long serialVersionUID = -2113251243;
     ...
     */
    public final TableField<InvoiceEventStatRecord, InvoiceEventCategory> EVENT_CATEGORY = createField("event_category", org.jooq.impl.SQLDataType.VARCHAR.nullable(false).asEnumDataType(com.rbkmoney.magista.domain.enums.InvoiceEventCategory.class), this, "");

    /**
     * The column <code>mst.invoice_event_stat.event_type</code>.
     */
    public final TableField<InvoiceEventStatRecord, InvoiceEventType> EVENT_TYPE = createField("event_type", org.jooq.impl.SQLDataType.VARCHAR.nullable(false).asEnumDataType(com.rbkmoney.magista.domain.enums.InvoiceEventType.class), this, "");
     ...
     */
    public final TableField<InvoiceEventStatRecord, InvoiceStatus> INVOICE_STATUS = createField("invoice_status", org.jooq.impl.SQLDataType.VARCHAR.nullable(false).asEnumDataType(com.rbkmoney.magista.domain.enums.InvoiceStatus.class), this, "");
     ...
     */
    public final TableField<InvoiceEventStatRecord, InvoicePaymentStatus> PAYMENT_STATUS = createField("payment_status", org.jooq.impl.SQLDataType.VARCHAR.asEnumDataType(com.rbkmoney.magista.domain.enums.InvoicePaymentStatus.class), this, "");
     ...
     */
    public final TableField<InvoiceEventStatRecord, FailureClass> PAYMENT_OPERATION_FAILURE_CLASS = createField("payment_operation_failure_class", org.jooq.impl.SQLDataType.VARCHAR.asEnumDataType(com.rbkmoney.magista.domain.enums.FailureClass.class), this, "");
     ...
     */
    public final TableField<InvoiceEventStatRecord, BankCardTokenProvider> PAYMENT_BANK_CARD_TOKEN_PROVIDER = createField("payment_bank_card_token_provider", org.jooq.impl.SQLDataType.VARCHAR.asEnumDataType(com.rbkmoney.magista.domain.enums.BankCardTokenProvider.class), this, "");
    ...
    public InvoiceEventStat() {
        this(DSL.name("invoice_event_stat"), null);
    }
    ...
    public InvoiceEventStat(String alias) {
        this(DSL.name(alias), INVOICE_EVENT_STAT);
    }

    /**
     * Create an aliased <code>mst.invoice_event_stat</code> table reference
     */
    public InvoiceEventStat(Name alias) {
        this(alias, INVOICE_EVENT_STAT);
    }

    private InvoiceEventStat(Name alias, Table<InvoiceEventStatRecord> aliased) {
        this(alias, aliased, null);
    }

    private InvoiceEventStat(Name alias, Table<InvoiceEventStatRecord> aliased, Field<?>[] parameters) {
        super(alias, null, aliased, parameters, DSL.comment(""));
    }

    public <O extends Record> InvoiceEventStat(Table<O> child, ForeignKey<O, InvoiceEventStatRecord> key) {
        super(child, key, INVOICE_EVENT_STAT);
    }
    ...
    public List<Index> getIndexes() {
        return Arrays.<Index>asList(Indexes.EVENT_INVOICE_MS_KEY, Indexes.INVOICE_EVENT_STAT_PKEY, Indexes.INVOICE_STAT_EVENT_CATEGORY_EVENT_CREATED_AT_IDX, Indexes.INVOICE_STAT_EVENT_CATEGORY_PARTY_ID_SHOP_ID_EVENT_CREATED_AT_I, Indexes.INVOICE_STAT_INVOICE_CREATED_AT_IDX, Indexes.INVOICE_STAT_PAYMENT_CREATED_AT_IDX);
    }
    ...
    public InvoiceEventStat as(String alias) {
        return new InvoiceEventStat(DSL.name(alias), this);
    }
     ...
     */
    @Override
    public InvoiceEventStat as(Name alias) {
    ...
    public InvoiceEventStat rename(String name) {
        return new InvoiceEventStat(DSL.name(name), null);
    }
     ...
     */
    @Override
    public InvoiceEventStat rename(Name name) {
