    ...
    public Collection<Map.Entry<Long, StatPayment>> getPaymentsForReport(
        ...
        Query query = getDslContext()
                .select(
                        ...
                        PAYMENT_DATA.PAYMENT_RECURRENT_FLAG,
                        PAYMENT_DATA.PAYMENT_RECURRENT_TOKEN_SOURCE_TYPE,
                        PAYMENT_DATA.PAYMENT_RECURRENT_TOKEN_SOURCE_INVOICE_ID,
                        PAYMENT_DATA.PAYMENT_RECURRENT_TOKEN_SOURCE_PAYMENT_ID,
