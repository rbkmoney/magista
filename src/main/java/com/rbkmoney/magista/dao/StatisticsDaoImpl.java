...
public class StatisticsDaoImpl extends AbstractDao implements StatisticsDao {
    ...
    @Override
    public Collection<Map<String, String>> getAccountingDataByPeriod(Instant fromTime, Instant toTime, Optional<List<Integer>> shopCategoryIds) throws DaoException {
        ...
        MapSqlParameterSource params = new MapSqlParameterSource()
                ...
                .addValue("shop_categories", shopCategoryIds.orElse(Arrays.asList(-1)));
