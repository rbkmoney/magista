...
insert into mst.payment_data (invoice_id, payment_id, party_id, party_shop_id, party_contract_id, payment_currency_code, payment_amount, payment_payer_type, payment_tool, payment_customer_id, payment_bank_card_masked_pan, payment_bank_card_bin, payment_bank_card_token, payment_bank_card_system, payment_flow, payment_session_id, payment_fingerprint, payment_ip, payment_phone_number, payment_email, payment_created_at)
VALUES ('INVOICE_ID_1', 'PAYMENT_ID_1', 'DB79AD6C-A507-43ED-9ECF-3BBD88475B32', 'SHOP_ID', 'CONTRACT_ID', 'RUB', 50000, 'customer', 'bank_card', 'test', '4242', '424242', 'eriogmiorwgeiroameriovmerio', 'visa', 'instant', 'payment_session_1', 'qweqweldasksldfmdslkfm', '34.23.44.33', '88005553535', 'qwe@mail.ru', now());
