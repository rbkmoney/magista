...
values ('INVOICE_NEW_ID_4', 1, 'INVOICE_CREATED', now(), 'TEST_ALLOCATION_ID', 'testOwnerId', 'testShopId', 9000, 'RUB', 'testFeeTargetOwnerId', 'testFeeTargetShopId', 1000, 'RUB', 10, 1, null, 10000, 'RUB', null);

insert into mst.allocation_transaction_data(invoice_id, event_id, event_type, event_created_at, allocation_id, target_owner_id, target_shop_id, amount, currency, fee_target_owner_id, fee_target_shop_id, fee_amount, fee_currency, fee_rational_p, fee_rational_q, fee_rounding_method, total_amount, total_currency, invoice_cart_json)
values ('INVOICE_NEW_ID_4', 2, 'INVOICE_PAYMENT_STATUS_CHANGED', now() + interval '5 minute', 'TEST_ALLOCATION_ID2', 'testOwnerId2', 'testShopId2', 6000, 'RUB', 'testFeeTargetOwnerId', 'testFeeTargetShopId', 500, 'RUB', 5, 1, null, 6500, 'RUB', null);
