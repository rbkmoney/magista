...
insert into mst.invoice_data (event_id, event_created_at, event_type, party_id, party_shop_id, invoice_id, invoice_status, invoice_product, invoice_description, invoice_amount, invoice_currency_code, invoice_due, invoice_created_at)
values (10, now() + interval '30 minute', 'INVOICE_CREATED', 'DB79AD6C-A507-43ED-9ECF-3BBD88475B32', 'SHOP_ID', 'INVOICE_NEW_ID_3', 'unpaid', 'INVOICE_PRODUCT', 'INVOICE_DESCRIPTION', 50000, 'RUB', now(), now() + interval '10 second');
-- payment transaction bound
insert into mst.payment_data (event_id, event_created_at, event_type, invoice_id, payment_id, payment_status, party_id, party_shop_id, payment_currency_code, payment_origin_amount, payment_amount, payment_fee, payment_provider_fee, payment_external_fee, payment_domain_revision, payment_payer_type, payment_tool, payment_bank_card_last4, payment_bank_card_first6, payment_bank_card_token, payment_bank_card_system, payment_bank_card_token_provider, payment_flow, payment_hold_on_expiration, payment_hold_until, payment_session_id, payment_fingerprint, payment_ip, payment_phone_number, payment_email, payment_created_at, payment_rrn, payment_approval_code)
VALUES (15, now(), 'INVOICE_PAYMENT_TRANSACTION_BOUND', 'INVOICE_NEW_ID_3', 'PAYMENT_ID_1', 'pending', 'DB79AD6C-A507-43ED-9ECF-3BBD88475B32', 'SHOP_ID', 'RUB', 50000, 50000, 55, 5, 0, 1, 'payment_resource', 'bank_card', '4242', '424242', 'eriogmiorwgeiroameriovmerio', 'mastercard', 'applepay', 'hold', 'cancel', now(), 'payment_session_1', 'qweqweldasksldfmdslkfm', '34.23.44.33', '88005553535', 'qwe@mail.ru', now() + interval '10 seconds', '43253', '5324');

insert into mst.invoice_data (event_id, event_created_at, event_type, party_id, party_shop_id, invoice_id, invoice_status, invoice_product, invoice_description, invoice_amount, invoice_currency_code, invoice_due, invoice_created_at)
values (10, now() + interval '30 minute', 'INVOICE_CREATED', 'B9C3BF7F-F62A-4675-8489-2DA7775024BB', '12345', 'INVOICE_NEW_ID_4', 'unpaid', 'INVOICE_PRODUCT', 'INVOICE_DESCRIPTION', 10, 'RUB', now(), now() + interval '7 second');

insert into mst.payment_data (event_id, event_created_at, event_type, invoice_id, payment_id, payment_status, party_id, party_shop_id, payment_currency_code, payment_origin_amount, payment_amount, payment_fee, payment_provider_fee, payment_external_fee, payment_domain_revision, payment_payer_type, payment_tool, payment_bank_card_last4, payment_bank_card_first6, payment_bank_card_token, payment_bank_card_system, payment_flow, payment_hold_on_expiration, payment_hold_until, payment_session_id, payment_fingerprint, payment_ip, payment_phone_number, payment_email, payment_created_at)
VALUES (11, now(), 'INVOICE_PAYMENT_STARTED', 'INVOICE_NEW_ID_4', 'PAYMENT_ID_1', 'pending', 'B9C3BF7F-F62A-4675-8489-2DA7775024BB', '12345', 'RUB', 50000, 50000, 55, 5, 0, 1, 'payment_resource', 'bank_card', '4242', '424242', 'eriogmiorwgeiroameriovmerio', 'visa', 'hold', 'cancel', now(), 'payment_session_1', 'qweqweldasksldfmdslkfm', '34.23.44.33', '88005553535', 'qwe@mail.ru', now() + interval '5 seconds');

insert into mst.invoice_data (event_id, event_created_at, event_type, party_id, party_shop_id, invoice_id, invoice_status, invoice_product, invoice_description, invoice_amount, invoice_currency_code, invoice_due, invoice_created_at)
values (10, now() + interval '30 minute', 'INVOICE_CREATED', 'B9C3BF7F-F62A-4675-8489-2DA7775024BB', '6789', 'INVOICE_NEW_ID_5', 'unpaid', 'INVOICE_PRODUCT', 'INVOICE_DESCRIPTION', 10, 'RUB', now(), now() + interval '7 second');

insert into mst.payment_data (event_id, event_created_at, event_type, invoice_id, payment_id, payment_status, party_id, party_shop_id, payment_currency_code, payment_origin_amount, payment_amount, payment_fee, payment_provider_fee, payment_external_fee, payment_domain_revision, payment_payer_type, payment_tool, payment_bank_card_last4, payment_bank_card_first6, payment_bank_card_token, payment_bank_card_system, payment_flow, payment_hold_on_expiration, payment_hold_until, payment_session_id, payment_fingerprint, payment_ip, payment_phone_number, payment_email, payment_created_at)
VALUES (11, now(), 'INVOICE_PAYMENT_STARTED', 'INVOICE_NEW_ID_5', 'PAYMENT_ID_2', 'pending', 'B9C3BF7F-F62A-4675-8489-2DA7775024BB', '6789', 'RUB', 50000, 50000, 55, 5, 0, 1, 'payment_resource', 'bank_card', '4242', '424242', 'eriogmiorwgeiroameriovmerio', 'visa', 'hold', 'cancel', now(), 'payment_session_1', 'qweqweldasksldfmdslkfm', '34.23.44.33', '88005553535', 'qwe@mail.ru', now() + interval '10 seconds');

insert into mst.allocation_transaction_data(invoice_id, allocation_id, target_owner_id, target_shop_id, amount, currency, fee_target_owner_id, fee_target_shop_id, fee_amount, fee_currency, fee_rational_p, fee_rational_q, fee_rounding_method, total_amount, total_currency, invoice_cart_json)
values ('INVOICE_NEW_ID_4', 'TEST_ALLOCATION_ID', 'testOwnerId', 'testShopId', 9000, 'RUB', 'testFeeTargetOwnerId', 'testFeeTargetShopId', 1000, 'RUB', 10, 1, null, 10000, 'RUB', null);

insert into mst.allocation_transaction_data(invoice_id, allocation_id, target_owner_id, target_shop_id, amount, currency, fee_target_owner_id, fee_target_shop_id, fee_amount, fee_currency, fee_rational_p, fee_rational_q, fee_rounding_method, total_amount, total_currency, invoice_cart_json)
values ('INVOICE_NEW_ID_4', 'TEST_ALLOCATION_ID2', 'testOwnerId2', 'testShopId2', 6000, 'RUB', 'testFeeTargetOwnerId', 'testFeeTargetShopId', 500, 'RUB', 5, 1, null, 6500, 'RUB', null);

insert into mst.allocation_transaction_data(invoice_id, allocation_id, target_owner_id, target_shop_id, amount, currency, fee_target_owner_id, fee_target_shop_id, fee_amount, fee_currency, fee_rational_p, fee_rational_q, fee_rounding_method, total_amount, total_currency, invoice_cart_json)
values ('INVOICE_NEW_ID_4', 'TEST_ALLOCATION_ID3', 'testOwnerId3', 'testShopId3', 8000, 'RUB', 'testFeeTargetOwnerId', 'testFeeTargetShopId', 1500, 'RUB', 15, 1, null, 9500, 'RUB', null);
