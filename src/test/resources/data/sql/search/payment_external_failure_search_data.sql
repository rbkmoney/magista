...
insert into mst.payment_event (event_id, event_created_at, event_type, invoice_id, payment_id, payment_status, payment_currency_code, payment_amount, payment_fee, payment_provider_fee, payment_external_fee, payment_domain_revision, payment_operation_failure_class, payment_external_failure, payment_external_failure_reason)
VALUES (2, now(), 'INVOICE_PAYMENT_STATUS_CHANGED', 'INVOICE_ID_1', 'PAYMENT_ID_1', 'failed', 'RUB', 50000, 55, 5, 0, 1, 'failure', 'test.test.test', 'test');
