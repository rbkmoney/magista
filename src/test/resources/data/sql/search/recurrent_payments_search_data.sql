...
insert into mst.payment_data (id, invoice_id, payment_id, party_id, party_shop_id, party_contract_id, payment_currency_code, payment_amount, payment_tool, payment_bank_card_masked_pan, payment_bank_card_bin, payment_bank_card_token, payment_bank_card_system, payment_flow, payment_hold_on_expiration, payment_hold_until, payment_session_id, payment_fingerprint, payment_ip, payment_phone_number, payment_email, payment_created_at, payment_recurrent_flag, payment_recurrent_token_source_type, payment_recurrent_token_source_invoice_id, payment_recurrent_token_source_payment_id)
    VALUES (1, 'INVOICE_ID_1', 'PAYMENT_ID_1', 'DB79AD6C-A507-43ED-9ECF-3BBD88475B32', 'SHOP_ID', 'CONTRACT_ID', 'RUB', 50000, 'bank_card', '4242', '424242', 'eriogmiorwgeiroameriovmerio', 'visa', 'hold', 'cancel', now(), 'payment_session_1', 'qweqweldasksldfmdslkfm', '34.23.44.33', '88005553535', 'qwe@mail.ru', now() + interval '2 seconds', true, 'payment', 'PARENT_INVOICE_ID_1', 'PARENT_PAYMENT_ID_1');
