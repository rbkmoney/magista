...
public class JsonQueryParserTest {
    ...
    public void testWithoutShopAndMerchantId() throws Exception {
        String json = "{'query': {'payments': {'invoice_id':'A','payment_id':'B', 'payment_last_digits':'1212','from_time': '2016-03-22T00:12:00Z','to_time': '2016-03-22T01:12:00Z'}}}";
        parser.parseQuery(json);
    }

    @Test(expected = QueryParserException.class)
    public void testWithoutMerchantButWithShopId() throws Exception {
        String json = "{'query': {'payments': {'shop_id':'C','invoice_id':'A','payment_id':'B', 'payment_pan_mask':'1212','from_time': '2016-03-22T00:12:00Z','to_time': '2016-03-22T01:12:00Z'}}}";
        parser.parseQuery(json);
    }
